...
import { IConfigShowTimeoutMessage, IPositionMessage, ISetOfPolylines } from 'src/app/shared/interfaces/IMessage';
...
export class Tab1Page {
  ...
  constructor(private messageService: MessageHubService) {
    ...
    this.subscription = this.messageService.onMessage().subscribe(message => {
      ...
      else if (message.tag == "setOfPolylines") {
         this.map.polyLineSet = (<ISetOfPolylines>message).content;
      }
